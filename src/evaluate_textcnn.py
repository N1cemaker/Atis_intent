...
def main():
    ...
    # 1) load test 数据（processed/test.txt）
    ...
    # 2) Create TextCNN and Load weight
    ...
    plt.tight_layout()
    fig_path_counts = "reports/figures/textcnn_confusion_matrix_counts.png"
    ...
    plt.tight_layout()
    fig_path_norm = "reports/figures/textcnn_confusion_matrix_norm.png"
